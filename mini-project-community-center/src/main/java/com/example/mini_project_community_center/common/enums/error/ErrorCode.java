...
public enum ErrorCode {
    ...
    PASSWORD_MISMATCH(HttpStatus.BAD_REQUEST, "A008", "비밀번호가 틀렸습니다.", "Password mismatch"),
    PASSWORD_CONFIRM_MISMATCH(HttpStatus.BAD_REQUEST, "A009", "비밀번호 확인이 일치하지 않습니다.", "Password mismatch"),
    DUPLICATE_EMAIL(HttpStatus.CONFLICT, "A010", "이미 가입된 이메일입니다.", "Duplicate email"),
